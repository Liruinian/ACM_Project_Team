...
function newart() {
  ...
  httpRequest.open("POST", "http://127.0.0.1:8880/upload-art", true);
...
function delart() {
  ...
  var httpRequest = new XMLHttpRequest();
  httpRequest.open("POST", "http://127.0.0.1:8880/delete-art", true);
  httpRequest.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
...
function logout() {
  var httpRequest = new XMLHttpRequest();
  httpRequest.open("POST", "http://127.0.0.1:8880/logout", true);
  httpRequest.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
  httpRequest.send();
  httpRequest.onreadystatechange = function () {
    if (httpRequest.readyState == 4 && httpRequest.status == 200) {
...
function load_articles() {
  var httpRequest = new XMLHttpRequest();
  httpRequest.open("POST", "http://127.0.0.1:8880/get-articles", true);
  httpRequest.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
  httpRequest.send();
  httpRequest.onreadystatechange = function () {
    if (httpRequest.readyState == 4 && httpRequest.status == 200) {
...
function user_classify() {
  ...
  let uInfo = "";
  var httpRequest = new XMLHttpRequest();
  httpRequest.open("POST", "http://127.0.0.1:8880/userinfo", true);
  httpRequest.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
  httpRequest.send();
  httpRequest.onreadystatechange = function () {
    if (httpRequest.readyState == 4 && httpRequest.status == 200) {
